import { DigitalReadingRoom } from "@/components/librarian/digital-reading-room";
...
export default function DigitalReadingRoomPage() {
	return (
			...
			<div className="flex h-screen">
				...
				<div className="flex-1 flex flex-col overflow-hidden">
					...
					<main className="flex-1 overflow-x-hidden overflow-y-auto bg-background p-6">
						<DigitalReadingRoom librarianData={mockLibrarianData} />
					</main>
				</div>
			</div>
		</div>
